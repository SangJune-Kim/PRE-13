...
function checkPhonenumber(){
    ...
    if(ph1.length === 3 && ph2.length === 4 && ph3.length === 4){
        ...
        document.getElementById("authButton").setAttribute("style","background-color : white")
        ...
        document.getElementById("authButton").setAttribute("style","background-color : none")
    ...
    if(isStarted === false){
            ...
            timer = setInterval(function(){
                ...
                if(time >= 0){
                    ...
                    document.getElementById("completeBtn").style.backgroundColor = "#0068FF"
...
function checkValidation(){
    ...
    if(email !== "" && name !== "" && pw1 !== "" && pw2 !== ""){
        ...
        document.getElementById("submit").setAttribute("style","background-color : white")
